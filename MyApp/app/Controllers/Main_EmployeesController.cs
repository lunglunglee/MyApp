...
namespace Myapp.Controllers
{
    public class Main_EmployeesController : Controller
    {
        ...
        {
            var main_Employees = db.Main_Employees.Include(m => m.EmployeeTerritories).Include(m => m.Main_Employees2);
            return View(await main_Employees.ToListAsync());
        }
        ...
        {
            ViewBag.EmployeeID = new SelectList(db.EmployeeTerritories, "代理Id", "代理名稱");
            ViewBag.ReportsTo = new SelectList(db.Main_Employees, "EmployeeID", "代理稱謂");
            return View();
        }
        ...
        public async Task<ActionResult> Create([Bind(Include = "EmployeeID,代理稱謂,FirstName,Title,TitleOfCourtesy,BirthDate,HireDate,Address,City,Region,PostalCode,Country,HomePhone,Extension,Photo,Notes,ReportsTo,PhotoPath")] Main_Employees main_Employees)
        {
            ...
            ViewBag.EmployeeID = new SelectList(db.EmployeeTerritories, "代理Id", "代理名稱", main_Employees.EmployeeID);
            ViewBag.ReportsTo = new SelectList(db.Main_Employees, "EmployeeID", "代理稱謂", main_Employees.ReportsTo);
            return View(main_Employees);
        }
